...
MARKS = (
    ...
    dict(
        name="P9_VALVE_V2B",
        cell="v2b",
        loc=(1.018, 14.48, 2.32),
        w=0.11,
        h=0.042,
        normal="-X",
        mat="paint",
        meaning="Zone B valve identity V-2B on the service wall at line 2",
        rank="secondary",
        zone="B",
    ),
    dict(
...
def write_report(validation: dict) -> Path:
    ...
    lines = [
        ...
        "  P9_VALVE_V2B：Zone B 閥旁牆面 y=14.48 z=2.32，V-2B。",
        "",
        "PIPE IDENTIFICATION",
        ...
        "  日期只暗示曾有人巡檢，不建立劇情年表。",
        "  既有缺陷（未改）：MARK_INSP_B 被 Phase 8 控制櫃指示塊／搭扣部分遮住。",
        "",
        "ZONE A",
