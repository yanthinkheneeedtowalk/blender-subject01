...
def add_dirt_layer(mat: bpy.types.Material, floor: bool) -> None:
    ...
    if floor:
        stain = p106.noise(nt, pos, 12.0, 2.0, (-680, 180), 0.56, 0.04)
        stain_m = p106.map_range(nt, stain.outputs["Fac"], 0.30, 0.70, 0.0, 0.46, (-480, 180))
        stained = p106.mix_col(nt, stain_m, color, (0.012, 0.014, 0.013), (-40, 520))
        link(nt, stained, base_socket)
        worn = p106.noise(nt, pos, 20.0, 2.5, (-680, 20), 0.48, 0.02)
        worn_m = p106.map_range(nt, worn.outputs["Fac"], 0.54, 0.80, 0.0, 0.16, (-480, 20))
        worn_color = p106.mix_col(nt, worn_m, stained, (0.19, 0.19, 0.18), (220, 520))
